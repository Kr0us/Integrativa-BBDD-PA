...
class AdminApp:
    def __init__(self, master):
        self.master = master
        self.master.title("Casa de la Impresión - ADMIN")
    ...
    def create_widgets(self):
        ...
        boton_metodo_pago = ctk.CTkButton(
            ...
            compound="left",
            command=lambda: self.abrir_crud("Metodo_Pago"),
            width=120,
            height=32
        )
        ...
        boton_cliente_producto = ctk.CTkButton(
            ...
            compound="left",
            command=lambda: self.abrir_crud("Cliente_Producto"),
            width=120,
            height=32
        )
        ...
        boton_usuarios = ctk.CTkButton(
            ...
            compound="left",
            command=lambda: self.abrir_crud("usuarios"),
            width=120,
            height=32
        )
